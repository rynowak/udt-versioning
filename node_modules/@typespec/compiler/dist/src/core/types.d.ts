 ...
 */
export type MemberContainerNode = ModelStatementNode | ModelExpressionNode | InterfaceStatementNode | EnumStatementNode | UnionStatementNode | ScalarStatementNode;
...
export type DocTag = DocReturnsTagNode | DocErrorsTagNode | DocParamTagNode | DocPropTagNode | DocTemplateTagNode | DocUnknownTagNode;
...
export type LinterRuleDiagnosticFormat<T extends DiagnosticMessages, M extends keyof T = "default"> = T[M] extends CallableMessage<infer A> ? {
    format: Record<A[number], string>;
} : Record<string, unknown>;
export type LinterRuleDiagnosticReportWithoutTarget<T extends DiagnosticMessages, M extends keyof T = "default"> = {
    messageId?: M;
    codefixes?: CodeFix[];
} & LinterRuleDiagnosticFormat<T, M>;
export type LinterRuleDiagnosticReport<T extends DiagnosticMessages, M extends keyof T = "default"> = LinterRuleDiagnosticReportWithoutTarget<T, M> & {
    target: DiagnosticTarget | typeof NoTarget;
};
...
export interface TypeSpecLibrary<T extends {
    [code: string]: DiagnosticMessages;
}, E extends Record<string, any> = Record<string, never>, State extends string = never> extends TypeSpecLibraryDef<T, E, State> {
    /** Library name */
    readonly name: string;
